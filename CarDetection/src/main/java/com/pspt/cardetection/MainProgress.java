...
public class MainProgress extends JFrame {
    ...
    public static void main(String[] args) {
        CarAlarmBusiness.load();
        CarAlarmBusiness.startProgress();
        frame.init();
    }
    ...
    public void init() {
        ...
        btn2.addActionListener(e -> {
            for (Object object : HikCache.hikBusinessMap.values()) {
                HikBusiness hikBusiness = (HikBusiness) object;
