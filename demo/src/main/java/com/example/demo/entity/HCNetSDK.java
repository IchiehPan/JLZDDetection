...
//用于NET_DVR_SetDVRConfig和NET_DVR_GetDVRConfig,注意其对应的配置结构
    ...
    public static final int NET_DVR_GET_REFERENCE_REGION= 400;
...
//智能控制参数结构
    ...
    public static final int NET_DVR_SET_TRAVERSE_PLANE_DETECTION = 3361; //设置越界侦测配置 
    public static final int NET_DVR_GET_REGION_ENTR_DETECTION = 3503;  
    public static final int NET_DVR_GET_REGION_ENTR_REGION = 3505;  
//设备的配置信息配置
    ...
    public static final int COMM_ALARM_RULE = 0X1102; //xingweifenxi xinxi 
...
//校时结构参数
    ...
    public static class NET_VCA_FIELDDETECION extends Structure{
    	...
    	public NET_DVR_SCHEDTIME[] struAlarmSched = new NET_DVR_SCHEDTIME[56];
    ...
    public static class NET_DVR_ACTIVATECFG extends Structure{
    	public int dwSize;
...
//DVR设备参数
  public static class NET_DVR_DEVICECFG_V40 extends Structure {
        ...
        public byte[] bsbyDevTypeName =new byte[DEV_TYPE_NAME_LEN];
...
public static class NET_DVR_STD_CONFIG extends Structure{
	public Pointer IpCondBuffer;
	public int dwCondSize;
	public Pointer IpInBuffer;
	public int dwInSize;
	public Pointer IpOutBuffer;
	public int 	dwOutSize;
	public Pointer IpStatusBuffer;
	public int dwStatusSize;
	public Pointer IpXmlBuffer;
...
public static class NET_DVR_AID_INFO  extends Structure {
	...
	public byte[] byRes2 = new byte[38];  // 保留字节
}
...
public int MONITORSITE_ID_LEN = 48;
...
//进入zoom
public static class NET_DVR_REGIONENTRANCE_REGION extends Structure{
	public NET_VCA_POLYGON struRegion;
	public byte bySensitivity; 
...
public static class NET_VCA_TRAVERSE_PLANE_DETECTION extends Structure{
		...
		public byte byEnableHumanMisinfoFilter;
		public byte byEnableVehicleMisinfoFilter;
		public NET_VCA_TRAVERSE_PLANE[] struAlertParam = new NET_VCA_TRAVERSE_PLANE[MAX_ALERTLINE_NUM];
...
public static class NET_DVR_REGION_ENTRANCE_DETECTION extends Structure{
	public int dwSize;
	public byte byEnabled;
	public byte byEnableHumanMisinfoFilter;
	public byte byEnableVehicleMisinfoFilter;
	public byte byRes1;
	public NET_DVR_REGIONENTRANCE_REGION[] struRegion =new  NET_DVR_REGIONENTRANCE_REGION[MAX_REGION_NUM];
	public byte[] byRes2 = new byte[128];
...
public static class NET_DVR_REGION_LIST extends Structure {
		public int dwsize;
		public byte byNum;
		public byte[] byRes1 = new byte[3];		
		public NET_VCA_POLYGON[] struPolygon = new NET_VCA_POLYGON[MAX_REGION_NUM];
...
public static class NET_VCA_FACESNAP_INFO_ALARM extends Structure {
	...
	public byte[] byRes1 = new byte[3];              // 保留字节
...
public static class NET_DVR_PACKET_INFO_EX extends Structure{
	...
	public ByteByReference dwPacketBuffer;
...
public static class NET_DVR_RECORD_TIME_SPAN extends Structure{
 ...
 /***API函数声明,详细说明见API手册***/
   ...
   public static interface FPlayESCallBack extends Callback {  
       public void invoke(NativeLong lPreviewHandle, NET_DVR_PACKET_INFO_EX pstruPackInfo,
               Pointer pUser);
   }
...
//NET_DVR_SetDVRMessage的扩展
 ...
 boolean NET_DVR_SetESRealPlayCallBack(NativeLong IrealHandle,FPlayESCallBack fpPlayESCallBack ,Pointer pUser);
//预览相关接口
...
//文件查找与回放
 boolean  NET_DVR_InquiryRecordTimeSpan(NativeLong lUserID,int dwChannel,NET_DVR_RECORD_TIME_SPAN_INQUIRY IpInquiry,NET_DVR_RECORD_TIME_SPAN IpResult);
...
//参数配置 begin
 ...
 boolean  NET_DVR_GetSTDConfig(NativeLong lUserID,int dwCommand,NET_DVR_STD_CONFIG IpConfigParam);
...
//前面板锁定
 ...
 boolean NET_DVR_ActivateDevice(String sDVRIP,short wDVRPort,NET_DVR_ACTIVATECFG ipActivateCfg);
